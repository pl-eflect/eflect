...
public final class Sunflow implements BenchmarkTest {
  ...
  public static void main(String[] args) {
    ...
    String[] properties = {"aa.min", "aa.max", "aa.samples"};
    ...
    Knob[] knobs = new Knob[] {
      ...
      new DiscreteKnob("aa.samples", KnobValT.haveIntegers(1, 2))
    };
  ...
  public Sunflow(int resolution, int threads) {
