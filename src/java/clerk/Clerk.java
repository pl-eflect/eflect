...
import clerk.attribution.ClerkEnergyModule;
...
public class Clerk {
  ...
  private static final ProfilerFactory profilerFactory = DaggerClerk_ProfilerFactory.builder().build();
